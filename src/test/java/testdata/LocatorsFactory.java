...
public class LocatorsFactory extends StartupPage {
	...
	public CommonEvents commonEvents1;
	public LocatorsFactory(WebDriver driver) {
		super(driver);
		this.commonEvents1 = new CommonEvents(driver);
	...
	public String verifyEnteredInvestmentAmountIsPresent() throws Exception {
		...
		try {
			if(commonEvents1.isDisplayed(investmentAmountTextfield))
			{
			investmentAmountTextfieldValue = commonEvents1.getAttribute(investmentAmountTextfield, "value");
	...
	public String verifyEnteredInvestmentPeriodIsPresent() throws Exception {
		...
		try {
			if(commonEvents1.isDisplayed(investmentPeriodTextfield))
			{
			investmentPeriodTextfieldValue = commonEvents1.getAttribute(investmentPeriodTextfield, "value");
	...
	public String verifyEnteredRateOfReturnIsPresent() throws Exception {
		...
		try {
			if(commonEvents1.isDisplayed(rateOfReturnTextfield))
			{
			rateOfReturnTextfieldValue = commonEvents1.getAttribute(rateOfReturnTextfield, "value");
	...
	public String verifyTaxRateEnteredValueIsPresent() throws Exception {
		...
		try {
			if(commonEvents1.isDisplayed(taxRateTextfield))
			{
			taxRateTextfieldValue = commonEvents1.getAttribute(taxRateTextfield, "value");
	...
	public String verifyEnteredBasicMonthlySalaryIsPresent() throws Exception {
		...
		try {
			if(commonEvents1.isDisplayed(basicMonthlySalaryTextfield))
			{
			basicMonthlySalaryTextfieldValue = commonEvents1.getAttribute(basicMonthlySalaryTextfield, "value");
	...
	public String verifyEnteredValueInYourContributionToEPFIsPresent() throws Exception {
		...
		try {
			if(commonEvents1.isDisplayed(contributionToEPFTextfield))
			{
			contributionToEPFValue = commonEvents1.getAttribute(contributionToEPFTextfield, "value");
	...
	public String verifyEnteredYourEmployersContributionToEPFIsPresent() throws Exception {
		...
		try {
			if(commonEvents1.isDisplayed(employersContributionToEPFTextfield))
			{
			employersContributionToEPFValue = commonEvents1.getAttribute(employersContributionToEPFTextfield, "value");
	...
	public String verifyEnteredAvgIncreaseInSalaryYouExpectIsPresent() throws Exception {
		...
		try {
			if(commonEvents1.isDisplayed(avgIncreaseInSalaryYouExpectTextfield))
			{
			avgIncreaseInSalaryYouExpectValue = commonEvents1.getAttribute(avgIncreaseInSalaryYouExpectTextfield, "value");
	...
	public String verifyEnterAgeWhenYouIntendToRetireIsPresent() throws Exception {
		...
		try {
			if(commonEvents1.isDisplayed(ageWhenYouIntendToRetireTextfield))
			{
			ageWhenYouIntendToRetireValue = commonEvents1.getAttribute(ageWhenYouIntendToRetireTextfield, "value");
	...
	public String verifyEnteredCurrentEpfBalanceIfAnyIsPresent() throws Exception {
		...
		try {
			if(commonEvents1.isDisplayed(currentEpfBalanceIfAnyTextfield))
			{
			currentEpfBalanceIfAnyValue = commonEvents1.getAttribute(currentEpfBalanceIfAnyTextfield, "value");
	...
	public String verifyEnteredCurrentInterestRateIsPresent() throws Exception {
		...
		try {
			if(commonEvents1.isDisplayed(currentInterestRateTextfield))
			{
			currentInterestRateValue = commonEvents1.getAttribute(currentInterestRateTextfield, "value");
	...
	public String medicalDentalCostsValueIsPresent()throws Exception {
		...
		try
		{
		medicalDentalCostsTextFieldValue=commonEvents1.getAttribute(medicalDentalCostsTextField, "value");
		}
		catch(Exception e) {
			throw e;
		}	
	...
	public String vehicleRepaircostValueIsPresent()throws Exception {
		...
		try
		{
			vehicleRepaircostValueIsPresentTextFieldValue=commonEvents1.getAttribute(vehicleRepaircostTextField, "value");
		}
		catch(Exception e) {
			throw e;
		}	
	...
	public String otherCostTextFieldValueIsPresent()throws Exception {
		...
		try
		{
			otherCostTextFieldValue=commonEvents1.getAttribute(otherCostTextField, "value");
		}
		catch(Exception e) {
			throw e;
		}	
	...
	public String lifeInsurancePremiumTextFieldValueIsPresent()throws Exception {
		...
		try
		{
			lifeInsurancePremiumTextFieldValue=commonEvents1.getAttribute(lifeInsurancePremiumTextField, "value");
		}
		catch(Exception e) {
			throw e;
		}	
	...
	public String homeAndAutoInsurancePremiumextFieldValueIsPresent()throws Exception {
		...
		try
		{
			homeAndAutoInsurancePremiumextFieldValue=commonEvents1.getAttribute(homeAndAutoInsurancePremiumTextField, "value");
		}
		catch(Exception e) {
			throw e;
		}	
	...
	public String homeLoanAndOtherImportantEMIsTextFieldValueIsPresent()throws Exception {
		...
		try
		{
			homeLoanAndOtherImportantEMIsTextFieldValue=commonEvents1.getAttribute(homeLoanAndOtherImportantEMIsTextField, "value");
		}
		catch(Exception e) {
			throw e;
		}	
	...
	public String monthlyLivingExpensesTextFieldValueIsPresent()throws Exception {
		...
		try
		{
			monthlyLivingExpensesTextFieldValue=commonEvents1.getAttribute(monthlyLivingExpensesTextField, "value");
		}
		catch(Exception e) {
			throw e;
		}	
	...
	public String monthUnemployedTextFieldValueIsPresent()throws Exception {
		...
		try
		{
			monthUnemployedTextFieldValue=commonEvents1.getAttribute(monthUnemployedTextField, "value");
		}
		catch(Exception e) {
			throw e;
		}	
	...
	public String uninsuredOrUnexpectedEmergenciesFieldValueIsPresent()throws Exception {
		...
		try
		{
			uninsuredOrUnexpectedEmergenciesFieldValue=commonEvents1.getText(uninsuredOrUnexpectedEmergenciesField);
		}
		catch(Exception e) {
			throw e;
		}	
	...
	public String annualAmountOfFixedPaymentsFieldValueIsPresent()throws Exception {
		...
		try
		{
			annualAmountOfFixedPaymentsFieldValue=commonEvents1.getText(annualAmountOfFixedPaymentsField);
		}
		catch(Exception e) {
			throw e;
		}	
	...
	public String buildReserveToPayForJobLossFieldValueIsPresent()throws Exception {
		...
		try
		{
			buildReserveToPayForJobLossFieldValue=commonEvents1.getText(buildReserveToPayForJobLossField);
		}
		catch(Exception e) {
			throw e;
		}	
	...
	public String resultValueIsPresent()throws Exception {
		...
		try
		{
			resultValue=commonEvents1.getText(resultField);
		}
		catch(Exception e) {
			throw e;
		}	
	...
	public String forgotPasswordValueIsPresent()throws Exception {
		...
		try
		{
			 forgotPasswordValue=commonEvents1.getAttribute(passwordField, "value");
		}
		catch(Exception e) {
			throw e;
		}	
	...
	public String loanAmountTextFieldValueIsPresent()throws Exception {
		...
		try
		{
			loanAmountTextFieldValue=commonEvents1.getAttribute(loanAmountTextField, "value");
		}
		catch(Exception e) {
			throw e;
		}	
	...
	public String loanPeriodTextFieldValueIsPresent()throws Exception {
		...
		try
		{
			loanPeriodTextFieldValue=commonEvents1.getAttribute(loanPeriodTextField, "value");
		}
		catch(Exception e) {
			throw e;
		}	
	...
	public String interestRateTextFieldValueIsPresent()throws Exception {
		...
		try
		{
			interestRateTextFieldValue=commonEvents1.getAttribute(interestRateTextField, "value");
		}
		catch(Exception e) {
			throw e;
		}	
	...
	public String upfrontChargesTextFieldValueIsPresent()throws Exception {
		...
		try
		{
			upfrontChargesTextFieldValue=commonEvents1.getAttribute(upfrontChargesTextField, "value");
		}
		catch(Exception e) {
			throw e;
		}	
